...
import v1.RetrieveCharitableGiving.model.response.RetrieveCharitableGivingReliefHateoasData
...
class RetrieveCharitableGivingReliefControllerSpec
  ...
  private val requestData = Def1_RetrieveCharitableGivingReliefRequestData(Nino(nino), TaxYear.fromMtd(taxYear))
