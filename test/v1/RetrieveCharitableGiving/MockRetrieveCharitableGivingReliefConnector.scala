...
trait MockRetrieveCharitableGivingReliefConnector extends MockFactory {
  ...
  object MockRetrieveCharitableGivingReliefConnector {
    ...
    def retrieve(
        requestData: Def1_RetrieveCharitableGivingReliefRequestData): CallHandler[Future[DownstreamOutcome[RetrieveCharitableGivingReliefResponse]]] = {
      (mockConnector
        .retrieve(_: Def1_RetrieveCharitableGivingReliefRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
    }
