...
import v1.RetrieveCharitableGiving.def1.model.response.{
  Def1_GiftAidPayments,
  Def1_Gifts,
  Def1_NonUkCharities,
  Def1_RetrieveCharitableGivingReliefResponse
}
...
trait RetrieveCharitableGivingReliefFixture {
  ...
  val charitableGivingReliefResponse: Def1_RetrieveCharitableGivingReliefResponse =
    Def1_RetrieveCharitableGivingReliefResponse(
