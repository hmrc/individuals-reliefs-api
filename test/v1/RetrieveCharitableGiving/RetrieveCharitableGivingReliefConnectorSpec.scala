...
import v1.RetrieveCharitableGiving.def1.model.response.{Def1_GiftAidPayments, Def1_Gifts, Def1_NonUkCharities, Def1_RetrieveCharitableGivingReliefResponse}
import v1.RetrieveCharitableGiving.model.request.Def1_RetrieveCharitableGivingReliefRequestData
...
class RetrieveCharitableGivingReliefConnectorSpec extends ConnectorSpec {
  ...
  private val response = Def1_RetrieveCharitableGivingReliefResponse(
  ...
  trait Test {
    ...
    protected val request: Def1_RetrieveCharitableGivingReliefRequestData =
      Def1_RetrieveCharitableGivingReliefRequestData(
        nino = Nino(nino),
        taxYear = taxYear
      )
