...
class Def1RetrieveOtherReliefsResponseSpec extends UnitSpec with MockAppConfig {

  val retrieveOtherReliefsBody: Def1_RetrieveOtherReliefsResponse = Def1_RetrieveOtherReliefsResponse(
  ...
  "LinksFactory" should {
    "return the correct links" in {
      ...
      Def1_RetrieveOtherReliefsResponse.LinksFactory.links(mockAppConfig, RetrieveOtherReliefsHateoasData(nino, taxYear)) shouldBe
        Seq(
