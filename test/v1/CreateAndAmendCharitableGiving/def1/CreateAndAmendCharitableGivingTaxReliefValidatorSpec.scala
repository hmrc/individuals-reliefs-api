...
import api.models.errors.{BadRequestError, ErrorWrapper, NinoFormatError, RuleGiftAidNonUkAmountWithoutNamesError, RuleGiftsNonUkAmountWithoutNamesError, RuleIncorrectOrEmptyBodyError, RuleTaxYearNotSupportedError, RuleTaxYearRangeInvalidError, StringFormatError, TaxYearFormatError, ValueFormatError}
...
class CreateAndAmendCharitableGivingTaxReliefValidatorSpec extends UnitSpec with JsonErrorValidators {
  ...
  private val parsedBody = Def1_CreateAndAmendCharitableGivingTaxReliefBody(Some(parsedGiftAidPayments), Some(parsedGifts))
  ...
  "validator" should {
    "return the parsed domain object" when {
      "passed a valid request" in {
        ...
        result shouldBe Right(Def1_CreateAndAmendCharitableGivingTaxReliefRequestData(parsedNino, parsedTaxYear, parsedBody))
      }
      ...
      "passed a valid request with only gift payments included" in {
        ...
        result shouldBe Right(Def1_CreateAndAmendCharitableGivingTaxReliefRequestData(parsedNino, parsedTaxYear, parsedBody.copy(gifts = None)))
      }
      ...
      "passed a valid request with only gifts included" in {
        ...
        result shouldBe Right(
          Def1_CreateAndAmendCharitableGivingTaxReliefRequestData(parsedNino, parsedTaxYear, parsedBody.copy(giftAidPayments = None)))
      }
    }
