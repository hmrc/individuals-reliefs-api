...
class CreateAndAmendCharitableGivingTaxReliefServiceSpec extends ServiceSpec {
  ...
  val requestBody: Def1_CreateAndAmendCharitableGivingTaxReliefBody =
    Def1_CreateAndAmendCharitableGivingTaxReliefBody(
      giftAidPayments = Some(giftAidModel),
      gifts = Some(giftModel)
    )

  val requestData: Def1_CreateAndAmendCharitableGivingTaxReliefRequestData =
    Def1_CreateAndAmendCharitableGivingTaxReliefRequestData(Nino(nino), TaxYear.fromMtd(taxYear), requestBody)
