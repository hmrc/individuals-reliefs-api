...
class CreateAndAmendCharitableGivingControllerSpec
  ...
  private val requestBody = Def1_CreateAndAmendCharitableGivingTaxReliefBody(Some(giftAidPayments), None)
  ...
  private val requestData = Def1_CreateAndAmendCharitableGivingTaxReliefRequestData(Nino(nino), TaxYear.fromMtd(taxYear), requestBody)
