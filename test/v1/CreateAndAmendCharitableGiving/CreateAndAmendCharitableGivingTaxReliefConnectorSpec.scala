...
class CreateAndAmendCharitableGivingTaxReliefConnectorSpec extends ConnectorSpec {
  ...
  trait Test { _: ConnectorTest =>
    ...
    protected val request: Def1_CreateAndAmendCharitableGivingTaxReliefRequestData =
      Def1_CreateAndAmendCharitableGivingTaxReliefRequestData(Nino(nino), taxYear, requestBody)
