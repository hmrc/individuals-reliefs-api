...
trait MockCreateAndAmendReliefInvestmentsConnector extends TestSuite with MockFactory {
  ...
  object MockCreateAndAmendReliefInvestmentsConnector {
    ...
    def amend(requestData: Def1_CreateAndAmendReliefInvestmentsRequestData): CallHandler[Future[DownstreamOutcome[Unit]]] = {
      (mockConnector
        .amend(_: Def1_CreateAndAmendReliefInvestmentsRequestData)(_: HeaderCarrier, _: ExecutionContext, _: String))
        .expects(requestData, *, *, *)
    }
