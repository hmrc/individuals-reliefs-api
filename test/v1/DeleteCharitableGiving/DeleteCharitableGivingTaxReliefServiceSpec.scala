...
class DeleteCharitableGivingTaxReliefServiceSpec extends UnitSpec {
  ...
  trait Test extends MockDeleteCharitableGivingReliefConnector {
    ...
    protected val requestData: Def1_DeleteCharitableGivingTaxReliefRequestData =
      Def1_DeleteCharitableGivingTaxReliefRequestData(Nino(validNino), TaxYear.fromMtd(validTaxYear))
