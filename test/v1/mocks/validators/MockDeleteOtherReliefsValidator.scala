...
class MockDeleteOtherReliefsValidator extends MockFactory {
  ...
  val mockValidator: DeleteOtherReliefsValidator = mock[DeleteOtherReliefsValidator]

  object MockDeleteOtherReliefsValidator {

    def validate(data: DeleteOtherReliefsRawData): CallHandler1[DeleteOtherReliefsRawData, List[MtdError]] = {
      (mockValidator
