...
trait MockRetrieveForeignReliefsRequestParser extends MockFactory {

  val mockRequestDataParser: RetrieveForeignReliefsRequestParser = mock[RetrieveForeignReliefsRequestParser]
