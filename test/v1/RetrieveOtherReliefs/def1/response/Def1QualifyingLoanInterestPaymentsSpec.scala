...
import v1.RetrieveOtherReliefs.def1.model.response.Def1_QualifyingLoanInterestPayments

class Def1QualifyingLoanInterestPaymentsSpec extends UnitSpec with JsonErrorValidators {

  val qualifyingLoanInterestPayments: Def1_QualifyingLoanInterestPayments = Def1_QualifyingLoanInterestPayments(
    Some("myRef"),
    Some("Maurice"),
    763.00
  )

  val noOptionsQualifyingLoanInterestPayments: Def1_QualifyingLoanInterestPayments = Def1_QualifyingLoanInterestPayments(
    None,
    None,
    763.00
  )
  ...
  "reads from a JSON with no lender name" when {
    "passed a JSON with no customer lender name" should {
      "return a model with no customer lender name" in {
        noOptionsQualifyingLoanInterestPayments shouldBe noOptionsJson.as[Def1_QualifyingLoanInterestPayments]
      }
    }
  }
