...
import v1.RetrieveOtherReliefs.def1.model.response.Def1_QualifyingDistributionRedemptionOfSharesAndSecurities

class Def1QualifyingDistributionRedemptionOfSharesAndSecuritiesSpec extends UnitSpec with JsonErrorValidators {
