...
import v1.RetrieveOtherReliefs.def1.model.response.Def1_NonDeductibleLoanInterest

class Def1NonDeductibleLoanInterestSpec extends UnitSpec with JsonErrorValidators {

  val nonDeductibleLoanInterest: Def1_NonDeductibleLoanInterest = Def1_NonDeductibleLoanInterest(
    Some("myref"),
    763.00
  )

  val noRefNoneDeductibleLoanInterest: Def1_NonDeductibleLoanInterest = Def1_NonDeductibleLoanInterest(
    None,
    763.00
  )
