...
import v1.RetrieveOtherReliefs.def1.model.response.Def1_AnnualPaymentsMade

class Def1AnnualPaymentsMadeSpec extends UnitSpec with JsonErrorValidators {
  val annualPaymentsMade: Def1_AnnualPaymentsMade = Def1_AnnualPaymentsMade(Some("myRef"), 763.00)

  val noRefAnnualPaymentsMade: Def1_AnnualPaymentsMade = Def1_AnnualPaymentsMade(None, 763.00)
