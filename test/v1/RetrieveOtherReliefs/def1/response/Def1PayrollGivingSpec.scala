...
import v1.RetrieveOtherReliefs.def1.model.response.Def1_PayrollGiving

class Def1PayrollGivingSpec extends UnitSpec with JsonErrorValidators {

  val payrollGiving: Def1_PayrollGiving = Def1_PayrollGiving(
    Some("myRef"),
    154.00
  )

  val noRefPayrollGiving: Def1_PayrollGiving = Def1_PayrollGiving(
    None,
    154.00
  )
