...
import v1.RetrieveOtherReliefs.def1.model.response.Def1_PostCessationTradeReliefAndCertainOtherLosses

class Def1PostCessationTradeReliefAndCertainOtherLossesSpec extends UnitSpec with JsonErrorValidators {

  val postCessationTradeReliefAndCertainOtherLosses: Def1_PostCessationTradeReliefAndCertainOtherLosses = Def1_PostCessationTradeReliefAndCertainOtherLosses(
    Some("myRef"),
    Some("ACME Inc"),
    Some("2019-08-10"),
