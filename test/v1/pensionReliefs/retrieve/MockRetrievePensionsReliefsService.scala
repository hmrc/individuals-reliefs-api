...
trait MockRetrievePensionsReliefsService extends TestSuite with MockFactory {
  ...
  object MockRetrievePensionsReliefsService {
    ...
    def retrieve(requestData: RetrievePensionsReliefsRequestData)
        : CallHandler[Future[Either[ErrorWrapper, ResponseWrapper[RetrievePensionsReliefsResponse]]]] = {
      (mockService
