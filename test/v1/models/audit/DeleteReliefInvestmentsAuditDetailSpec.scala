...
class DeleteReliefInvestmentsAuditDetailSpec extends UnitSpec {
  ...
  val validBody = DeleteReliefInvestmentsAuditDetail(
    userType = "Agent",
  ...
  val invalidNinoBody = DeleteReliefInvestmentsAuditDetail(
    userType = "Agent",
    agentReferenceNumber = Some("012345678"),
    nino = "notANino",
    taxYear = "2019-20",
