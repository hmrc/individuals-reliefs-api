...
class CreateAndAmendForeignReliefsAuditDetailSpec extends UnitSpec {
  ...
  val validBody = CreateAndAmendForeignReliefsAuditDetail(
    userType = "Agent",
  ...
  val invalidNinoBody = CreateAndAmendForeignReliefsAuditDetail(
    userType = "Agent",
    agentReferenceNumber = Some("012345678"),
    nino = "notANino",
    taxYear = "2019-20",
