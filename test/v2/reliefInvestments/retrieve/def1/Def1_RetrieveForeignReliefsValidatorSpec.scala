...
package v2.reliefInvestments.retrieve.def1

import shared.models.domain.{Nino, TaxYear}
import shared.models.errors._
import shared.utils.UnitSpec
import v2.reliefInvestments.retrieve.RetrieveReliefInvestmentsValidatorFactory
...
class Def1_RetrieveForeignReliefsValidatorSpec extends UnitSpec {
  ...
  "running a validation" should {
    ...
    "return RULE_TAX_YEAR_FOR_VERSION_NOT_SUPPORTED error" when {
