...
import v2.createAndAmendForeignReliefs.def1.model.request._
...
class Def1_CreateAndAmendForeignReliefsValidatorSpec extends UnitSpec with JsonErrorValidators {
  ...
  private def validator(nino: String, taxYear: String, body: JsValue) = new Def1_CreateAndAmendForeignReliefsValidator(nino, taxYear, body)
