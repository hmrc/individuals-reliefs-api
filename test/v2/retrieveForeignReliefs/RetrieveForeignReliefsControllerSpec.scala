...
import v2.retrieveForeignReliefs.def1.model.response._
import v2.retrieveForeignReliefs.model.request.Def1_RetrieveForeignReliefsRequestData
import v2.retrieveForeignReliefs.model.response.{Def1_RetrieveForeignReliefsResponse, RetrieveForeignReliefsHateoasData}
