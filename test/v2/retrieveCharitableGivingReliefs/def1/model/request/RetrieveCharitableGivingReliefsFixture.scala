...
package v2.retrieveCharitableGivingReliefs.def1.model.request

import play.api.libs.json.{JsObject, JsValue, Json}
import v2.retrieveCharitableGivingReliefs.def1.model.response.{Def1_GiftAidPayments, Def1_Gifts, Def1_NonUkCharities}
import v2.retrieveCharitableGivingReliefs.model.response.Def1_RetrieveCharitableGivingReliefsResponse
