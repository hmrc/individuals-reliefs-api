...
import v3.reliefInvestments.delete.def1.Def1_DeleteReliefInvestmentsRequestData
...
class DeleteReliefInvestmentsControllerSpec
  ...
  trait Test extends ControllerTest with AuditEventChecking[GenericAuditDetail] {
    ...
    val controller: DeleteReliefInvestmentsController = new DeleteReliefInvestmentsController(
