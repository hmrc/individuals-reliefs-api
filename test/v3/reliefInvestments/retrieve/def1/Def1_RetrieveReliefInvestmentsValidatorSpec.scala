...
package v3.reliefInvestments.retrieve.def1
...
class Def1_RetrieveReliefInvestmentsValidatorSpec extends UnitSpec {
  ...
  private def validator(nino: String, taxYear: String) = new Def1_RetrieveReliefInvestmentsValidator(nino, taxYear)
