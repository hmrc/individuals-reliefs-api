...
class IndividualsReliefsAuthSupportingAgentsAllowedISpec extends AuthSupportingAgentsAllowedISpec {
  ...
  val downstreamUri = s"/income-tax/reliefs/investment/$nino/$taxYear"
