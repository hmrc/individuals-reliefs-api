...
class Def2_CreateAndAmendReliefInvestmentsControllerHipISpec extends IntegrationBaseSpec {
  ...
  "Calling the amend endpoint" should {
    ...
    "return a 400 with multiple errors" when {
      "all field value validations fail on the request body" in new TYStarting2025OnwardsTysTest {
    ...
    "return error according to spec" when {
      ...
      "validation error" when {
        def validationErrorTest(requestNino: String,
          ...
          s"validation fails with ${expectedBody.code} error" in new TYStarting2025OnwardsTysTest {
        ...
        val input = Seq(
          ("AA1123A", "2021-22", Def2_requestBodyJson, BAD_REQUEST, NinoFormatError),
          ("AA123456A", "20177", Def2_requestBodyJson, BAD_REQUEST, TaxYearFormatError),
          ("AA123456A", "2017-19", Def2_requestBodyJson, BAD_REQUEST, RuleTaxYearRangeInvalidError),
          ("AA123456A", "2019-20", Def2_requestBodyJson, BAD_REQUEST, RuleTaxYearNotSupportedError),
      ...
      "downstream service error" when {
        def serviceErrorTest(downstreamStatus: Int, downstreamCode: String, expectedStatus: Int, expectedBody: MtdError): Unit = {
          s"downstream returns an $downstreamCode error and status $downstreamStatus" in new TYStarting2025OnwardsTysTest {
