...
@Singleton
class CreateAndAmendCharitableGivingTaxReliefsService @Inject() (connector: CreateAndAmendCharitableGivingTaxReliefsConnector) extends BaseService {

  def amend(request: CreateAndAmendCharitableGivingTaxReliefsRequestData)(implicit
      ctx: RequestContext,
