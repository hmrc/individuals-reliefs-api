...
import v2.pensionReliefs.createAmend.def1.Def1_CreateAmendPensionReliefsValidator.validateBusinessRules
...
class Def1_CreateAmendPensionsReliefsValidator(nino: String, taxYear: String, body: JsValue)
  ...
  def validate: Validated[Seq[MtdError], CreateAmendPensionsReliefsRequestData] =
    (
      ...
      resolveJson(body)
    ).mapN(Def1_CreateAmendPensionsReliefsRequestData.apply) andThen validateBusinessRules
