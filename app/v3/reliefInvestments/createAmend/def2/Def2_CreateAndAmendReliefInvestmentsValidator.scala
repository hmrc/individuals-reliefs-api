...
class Def2_CreateAndAmendReliefInvestmentsValidator(nino: String, taxYear: String, body: JsValue)
  ...
  private val rulesValidator = Def2_CreateAndAmendReliefInvestmentsRulesValidator
  ...
  override def validate: Validated[Seq[MtdError], CreateAndAmendReliefInvestmentsRequestData] =
    (
      ...
      resolveJson(body)
    ).mapN(Def2_CreateAndAmendReliefInvestmentsRequestData) andThen rulesValidator.validateBusinessRules
