...
package v3.charitableGiving.createAmend.def2
...
import v3.charitableGiving.createAmend.def2.model.request
import v3.charitableGiving.createAmend.def2.model.request.{Def2_GiftAidPayments, Def2_Gifts}
import v3.charitableGiving.createAmend.model.request.Def2_CreateAndAmendCharitableGivingTaxReliefsRequestData
...
class Def2_CreateAndAmendCharitableGivingReliefsRulesValidator extends RulesValidator[Def2_CreateAndAmendCharitableGivingTaxReliefsRequestData] {
  ...
  def validateBusinessRules(parsed: Def2_CreateAndAmendCharitableGivingTaxReliefsRequestData)
    ...
    import parsed.body.*
    combine(giftAidPayments.traverse_(validateGiftAid), gifts.traverse_(validateGifts)).onSuccess(parsed)
  }
  ...
  def validateGifts(gifts: request.Def2_Gifts): Validated[Seq[MtdError], Unit] = {
    import gifts.*
