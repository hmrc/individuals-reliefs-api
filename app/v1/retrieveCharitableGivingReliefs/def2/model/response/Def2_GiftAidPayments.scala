...
case class Def2_GiftAidPayments(nonUkCharities: Option[Def2_NonUkCharities],
  ...
  implicit val reads: Reads[Def2_GiftAidPayments] = {
    val nonUkCharitiesOptionReads =
      ((JsPath \ "nonUkCharitiesCharityNames").readNullable[Seq[String]] and
        (JsPath \ "nonUkCharities").readNullable[BigDecimal])(Def2_NonUkCharities.from _)
    ...
    (nonUkCharitiesOptionReads and
      ...
      (JsPath \ "nextYearTreatedAsCurrentYear").readNullable[BigDecimal])(Def2_GiftAidPayments.apply _)
  }

  implicit val writes: Writes[Def2_GiftAidPayments] = Json.writes
