...
@Singleton
class AmendOtherReliefsConnector @Inject() (val http: HttpClientV2, val appConfig: SharedAppConfig) extends BaseDownstreamConnector {

  def amend(request: AmendOtherReliefsRequestData)(implicit
      hc: HeaderCarrier,
      ec: ExecutionContext,
