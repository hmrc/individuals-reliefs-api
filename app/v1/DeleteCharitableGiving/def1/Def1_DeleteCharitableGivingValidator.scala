...
package v1.DeleteCharitableGiving.def1
...
class Def1_DeleteCharitableGivingValidator(nino: String, taxYear: String) extends Validator[DeleteCharitableGivingTaxReliefRequestData] {

  def validate: Validated[Seq[MtdError], Def1_DeleteCharitableGivingTaxReliefRequestData] =
    (
      ResolveNino(nino),
      ResolveTaxYear(TaxYear.charitableGivingMinimumTaxYear.year, taxYear, None, None)
    ).mapN(Def1_DeleteCharitableGivingTaxReliefRequestData)
