...
class DeleteForeignReliefsValidator @Inject()(appConfig: AppConfig) extends Validator[DeleteForeignReliefsRawData] {
  ...
  override def validate(data: DeleteForeignReliefsRawData): List[MtdError] = {
