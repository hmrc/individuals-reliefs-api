...
class RetrieveCharitableGivingReliefValidator extends Validator[RetrieveCharitableGivingReliefRawData] {

  private val validationSet = List(parameterFormatValidation, parameterRuleValidation)

  private def parameterFormatValidation: RetrieveCharitableGivingReliefRawData => List[List[MtdError]] = data => {
    List(
